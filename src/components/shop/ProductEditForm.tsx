...
export default function ProductEditForm({
  ...
  return (
    <form
      ...
      className="bg-yellow-50 border border-yellow-300 rounded-xl p-3 sm:p-5 shadow-sm w-full"
    >
      {/* 헤더 */}
      <div className="flex items-center justify-between mb-3 sm:mb-4 pb-2 border-b border-yellow-300">
        <h3 className="text-base sm:text-sm font-semibold text-yellow-800">
          편집: {product.id}
        </h3>
      ...
      <div className="sm:hidden space-y-3">
        ...
        <div className="flex gap-2 pt-2">
          ...
          <button
            type="submit"
            disabled={isSubmitting}
            className="flex-1 px-4 py-3 text-base text-white bg-yellow-600 rounded-lg hover:bg-yellow-700 disabled:bg-gray-400"
          >
